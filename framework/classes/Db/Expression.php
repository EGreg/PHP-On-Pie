...
class Db_Expression
{
	 ...
	 * Constructor
	 *
	 * @param Db_Expression|string $chain1
	 *  Pass as many arguments as you want, and they will be concatenated together
	 *  with spaces in between them. 
	 *  Db_Expression objects will be enclosed in parentheses before being concatenated.
	 */
